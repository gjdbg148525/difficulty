...
public class EnderLightningBoltEntity extends LightningBoltEntity implements IEntity {
    private static final DamageSource DAMAGE_SOURCE = new DamageSource("enderLightningBolt") {
        ...
        if (this.life >= 0) {
            if (!(this.level instanceof ServerWorld)) {
                ...
                for (Entity entity : list) {
                    if (entity instanceof EnderDragonEntity || entity instanceof EnderDragonPartEntity) continue;
                    ...
                    ((IEntity) entity).multipleHurt(Maps.asMap(Sets.newHashSet(DAMAGE_SOURCE, DamageSource.IN_FIRE, DamageSource.MAGIC), ds -> finalDamage), (DamageAbsorb) null);
                }
            }
        }
    }
