...
public class Config {
    ...
    public static final ForgeConfigSpec.LongValue INITIAL_VALUE;
    public static final ForgeConfigSpec.IntValue INT_VALUE;

    static {
        ForgeConfigSpec.Builder CLIENT_BUILDER = new ForgeConfigSpec.Builder();
        CLIENT_BUILDER.push("server");
        DOUBLE_VALUE = CLIENT_BUILDER.defineInRange("difficulty_factor", 1d, 0d, 100d);
        INITIAL_VALUE = CLIENT_BUILDER.defineInRange("initial_difficulty", 0L, -Long.MAX_VALUE, Long.MAX_VALUE);
