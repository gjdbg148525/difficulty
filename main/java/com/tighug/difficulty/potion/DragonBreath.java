...
public class DragonBreath extends InstantEffect {
    ...
    public void applyEffectTick(@NotNull LivingEntity p_76394_1_, int p_76394_2_) {
        ...
        BigInteger bigInteger = new BigInteger("480").shiftLeft(p_76394_2_);
        ...
        ((IEntity) p_76394_1_).multipleHurt(Maps.asMap(Sets.newHashSet(DamageSource.MAGIC, DamageSource.DRAGON_BREATH) , ds -> finalF));
    }
}
